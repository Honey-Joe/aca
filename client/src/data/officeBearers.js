...
export const officeBearers = [
  ...
  // 01. CHAIR PERSON — 2
  { id: 1,  domain: 'Chair Person',        position: 'Chair Person',        name: 'Mathan Michael Raj A',  registerNumber: '2025178050', className: 'MCA (R)',  image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/Mathan(Ob).jpg', description: 'Chair Person of the Association of Computer Applications, providing leadership and direction for the association.' },
  { id: 2,  domain: 'Chair Person',        position: 'Chair Person',        name: 'Veera Kala Subiksha D', registerNumber: '2025179034', className: 'MCA (SS)', image: '/images/members/member-02.jpg', description: 'Chair Person of the Association of Computer Applications, supporting the association in achieving its goals and initiatives.' },
  ...
  { id: 4,  domain: 'General Secretary',   position: 'General Secretary',   name: 'Mohamed Haroon L',      registerNumber: '2025179013', className: 'MCA (SS)', image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/MohamedHaroon_GenSec_MCASS.jpg', description: 'General Secretary supporting the administration, coordination, and communication of ACA activities.' },
  ...
  { id: 11, domain: 'TechOps',             position: 'TechOps',             name: 'Sivagowtham B',         registerNumber: '2025178041', className: 'MCA (R)',  image: 'https://ik.imagekit.io/HoneyJoe/Gowtham_TechOps.jpeg', description: 'TechOps member contributing to the technical activities and technology-driven initiatives of ACA.' },
  ...
  { id: 17, domain: 'Alumni Relation',     position: 'Alumni Relation',     name: 'Shakthi Shwetha J',     registerNumber: '2025179030', className: 'MCA (SS)', image: 'https://ik.imagekit.io/HoneyJoe/Shakthi_Shwetha_J_ALUMNI_RELATIONS_MCA_SS.jpeg', description: 'Alumni Relation team member supporting interaction and coordination with the ACA alumni community.' },
  ...
  { id: 20, domain: 'HR and PR',           position: 'HR and PR',           name: 'Logesh Waran R',        registerNumber: '2025178043', className: 'MCA (R)',  image: '/images/members/member-20.jpg', description: 'HR and PR team member supporting internal coordination and external communication initiatives.' },
  ...
  { id: 23, domain: 'Logistics',           position: 'Logistics',           name: 'Sabharish G',           registerNumber: '2025179049', className: 'MCA (SS)', image: '/images/members/member-23.jpg', description: 'Logistics team member supporting the smooth operational execution of ACA activities.' },

  // 10. REPORTS — 1
  { id: 24, domain: 'Reports',             position: 'Reports',             name: 'Catherine Esther W',    registerNumber: '2025179025', className: 'MCA (SS)', image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/Catherine_Esther_W_Reports&Letters.jpg', description: 'Reports team member responsible for documenting ACA activities and maintaining official records.' },
