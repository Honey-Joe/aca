...
export const officeBearers = [
  ...
  // 06. DESIGN — 3
  { id: 12, domain: 'Design',              position: 'Design',              name: 'Leander Bertie',      registerNumber: '2025179018', className: 'MCA (SS)', image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/WhatsApp%20Image%202026-09-18%20at%2012.00.03%20PM.jpeg', description: 'Design team member contributing to the creative and visual communication initiatives of ACA.' },
  ...
  { id: 17, domain: 'Alumni Relation',     position: 'Alumni Relation',     name: 'Shakthi Shwetha J',     registerNumber: '2025179030', className: 'MCA (SS)', image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/Shakthi_Shwetha_J_Alumni_Relations.jpg', description: 'Alumni Relation team member supporting interaction and coordination with the ACA alumni community.' },
  ...
  { id: 19, domain: 'HR and PR',           position: 'HR and PR',           name: 'Raghunandhan K',        registerNumber: '2025178051', className: 'MCA (R)',  image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/Raghunandhank_HR&PR_MCAR.jpg', description: 'HR and PR team member contributing to communication, coordination, and outreach activities.' },
  ...
  { id: 21, domain: 'HR and PR',           position: 'HR and PR',           name: 'Amit',                  registerNumber: '2025178016', className: 'MCA (R)',  image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/Amit%20Hr%20and%20Pr.jpg', description: 'Logistics team member supporting the operational requirements of ACA activities.' },
  ...
  { id: 33, domain: 'Events',              position: 'Events',              name: 'Amitha B',              registerNumber: '2025178003', className: 'MCA (R)',  image: 'https://ik.imagekit.io/HoneyJoe/drive-download-20260914T095007Z-1-001/ChatGPT%20Image%20Sep%2018,%202026,%2011_52_27%20AM.png', description: 'Events team member contributing to the organization and smooth execution of ACA events.' },
];
