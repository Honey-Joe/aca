...
const events = [
  {
    ...
    date: '2026',
    category: 'Technical',
    desc: 'Annual technical event featuring innovative projects, technical competitions, and student activities.',
    color: '#9e373a',
    icon: '💻',
    size: 'large',
  },
  {
    ...
    date: '2026',
    category: 'Workshop',
    desc: 'Hands-on technical workshop conducted by GUVI to enhance programming and industry skills.',
    color: '#2b5f83',
    icon: '🌐',
    size: 'small',
  },
  {
    ...
    date: '2026',
    category: 'Cultural',
    desc: 'A memorable farewell celebration honoring graduating students and their academic journey.',
    color: '#9e373a',
    icon: '🎓',
    size: 'large',
  },
  {
    ...
    date: '2026',
    category: 'Cultural',
    desc: 'A warm welcome event for new students to connect, celebrate, and begin their college journey.',
    color: '#2b5f83',
    icon: '🎉',
    size: 'small',
  },
  {
    ...
    date: '2026',
    category: 'Seminar',
    desc: 'An interactive session with alumni sharing industry experiences, career guidance, and insights.',
    color: '#9e373a',
    icon: '🎤',
    size: 'small',
  },
  {
    ...
    desc: 'A collaborative coding event challenging students to develop innovative solutions to real-world problems.',
    color: '#2b5f83',
    icon: '⚡',
    size: 'large',
  },
